const CommanSheduleObject = {
    ...
    4: {xAxis : ["TravellingTeamName"], yAxis : ["TotalParty", "VisitedParty", 'Prc','SeenParty','SoldParty'], heading : "Schedule Client Details", iconclassName : "fas fa-chalkboard-teacher", sortingcolumn :"Prc"},
