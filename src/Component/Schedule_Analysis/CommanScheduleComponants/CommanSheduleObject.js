const CommanSheduleObject = {
    ...
    4: {xAxis : ["TravellingTeamName"], yAxis : ["TotalParty", "VisitedParty",'SeenParty','SoldParty', 'Prc'], heading : "Schedule Client Details", iconclassName : "fas fa-chalkboard-teacher", sortingcolumn :"Prc"},
    ...
    14: {xAxis : ["ScheduleName"], yAxis : ["TotalParty", "VisitedParty",'SeenParty','SoldParty',"Prc"], heading : "Schedule Wise Schedule Client Details", iconclassName : "fas fa-chalkboard-teacher", sortingcolumn :"Prc"},
