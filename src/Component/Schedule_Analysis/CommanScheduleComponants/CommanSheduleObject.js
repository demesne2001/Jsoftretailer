const CommanSheduleObject = {
    ...
    4: {xAxis : ["TravellingTeamName"], yAxis : ["TotalParty", "VisitedParty", 'Prc'], heading : "Schedule Client Details", iconclassName : "fas fa-chalkboard-teacher"},
    ...
    14: {xAxis : ["ScheduleName"], yAxis : ["TotalParty", "VisitedParty","Prc"], heading : "Schedule Wise Schedule Client Details", iconclassName : "fas fa-chalkboard-teacher"},
