                            ...
                            <div class="login-box">
                                ...
                                <form>
                                    <div class="user-box dd">
                                        <input className='user' type="text" name="LoginID" required onChange={handleoninputChange} />
                                        <label>Username</label>
                                    </div>
                                    <div class="user-box">
                                        <input className='user' type="password" name="PassWord" required onChange={handleoninputChange} />
